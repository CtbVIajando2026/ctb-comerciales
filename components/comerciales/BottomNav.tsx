...
export function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 w-full bg-background border-t border-border flex justify-around items-center h-16 pb-[env(safe-area-inset-bottom)] z-50 px-2">
      {tabs.map((tab) => {
